...
(function() {
    ...
    function createActionMenu() {
        ...
        const attachments = [ { id: 'photo', icon: '📷', label: 'Photo', type: 'images' }, { id: 'video', icon: '🎬', label: 'Video', type: 'videos' }, { id: 'audio', icon: '🎤', label: 'Audio', type: 'audio' }, { id: 'file', icon: '📎', label: 'File', type: 'file' }, ];
